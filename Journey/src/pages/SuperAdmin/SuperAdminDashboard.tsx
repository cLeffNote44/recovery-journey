              ...
              <QuickActions
                ...
                onExportReport={() => {
                  ...
                  const csvRows = [
                    ...
                    '',
                    ['Metric', 'Value'].join(','),
                    ['Total Facilities', stats.totalFacilities].join(','),
                    ['Total Staff', stats.totalStaff].join(','),
                    ['Total Patients', stats.totalPatients].join(','),
                    ['Active Patients', stats.activePatients].join(','),
                    '',
